...
// Обработчики событий для основной кнопки тапа
document.getElementById('cat-button').addEventListener('mousedown', e => e.preventDefault());
document.getElementById('cat-button').addEventListener('touchstart', e => e.preventDefault());
